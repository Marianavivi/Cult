...
function displayFiglet(text, color) {
    figlet(text, { horizontalLayout: 'default', verticalLayout: 'default' }, (err, data) => {
        if (err) {
...
displayFiglet('CULT', 'yellow');
displayFiglet('Advanced Whatsapp Bot', 'magenta');

app.use(express.static(path.join(__dirname, 'assets')));

app.get('/', (req, res) => {
    res.redirect('/cult.html');
});
