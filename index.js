...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const Mariana='254732647560';
             const Mariana1='254743032398'*/
            /*  var superUser=[servBot,Mariana,Mariana1].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[Mariana,Mariana1].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const superUserNumbers = [servBot, Mariana, Mariana1, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://files.catbox.moe/hplv2q.jpg';
    }
...
📌Powred by *CULT®🐐*`;
            ...
            let msg = ` *Goodbye Frinds group owner මෙත දැනුවත් කිරිමකි එක් පුද්ගලයෙක් group එකෙන් left උවා 📌 [POWER BY CULT]*\n`;
...
║❒ _Join *CULT* Channel for Updates_
https://whatsapp.com/channel/0029VaLYCPXJENxtW7BU9a0u_

║❒ *JOIN OUR WhatsApp Group*_
https://chat.whatsapp.com/JRkA9n11NIfFyXkuCXPv42_ 
